		...
		<div class="grid-container py-2">
			...
			<div class="grid-item">
				...
				<a href="<?php echo $ruta;  ?>">
					...
					<img src="img/logoGamarra.png" class="img-fluid">
				...
				<form action="<?php echo $ruta; ?>reservas" method="post">
					...
					<div class="formReservas py-1 py-lg-2 px-4">
						...
						<div class="form-group my-4">
							...
							<select class="form-control form-control-lg selectTipoProducto" required>
						...
						<div class="form-group my-4">
							<select class="form-control form-control-lg selectTemaProducto" name="id-habitacion" required>

								<option value="">Temática de producto</option>
						...
						<div class="row">
							...
							<div class="col-6 input-group input-group-lg pr-1">
								...
								<input type="text" class="form-control datepicker entrada" autocomplete="off" placeholder="Inicio" name="fecha-ingreso" required>
							...
							<div class="col-6 input-group input-group-lg pl-1">
								...
								<input type="text" class="form-control datepicker salida" autocomplete="off" placeholder="Entrega" name="fecha-salida" readonly required>
...
<nav class="menu container-fluid p-0">
	...
	<ul class="nav nav-justified py-2">
		...
		<li class="nav-item">
			<a class="nav-link text-white" href="#planes">Temporadas</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white" href="#habitaciones">Categorías</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white" href="#pueblo">El Emporio</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white" href="#restaurante">Empresa</a>
		</li>
