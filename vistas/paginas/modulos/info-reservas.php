		...
		<div class="row">
			...
			<div class="col-12 col-lg-8 colIzqReservas p-0">
				...
				<?php if ($valor == $_POST["ruta"]): ?>
					...
					<h1 class="pb-5 float-left">Haz tu pedido</h1>
				...
				<?php endif ?>
					...
					<div class="float-right pb-3">
						...
						<ul>
							<li>
								<i class="fas fa-square-full" style="color:#847059"></i> Fuera de Atención
							</li>
							...
							<li>
								<i class="fas fa-square-full" style="color:#FFCC29"></i> Tu pedido
							</li>
						</ul>
					...
					<!--------
					AQUI EMPIEZA EL MODULO CREAR PEDIDO
					-->
				...
				<!--------
					AQUI TERMINA EL MODULO CREAR PEDIDO
				-->
					...
					<?php if (isset($_SESSION["validarSesion"])): ?>
						...
						<?php if ($_SESSION["validarSesion"] == "ok"): ?>
							...
							<a href="<?php echo $ruta;?>perfil" 
								...
								personas="2">
									<button type="button" class="btn btn-dark btn-lg w-100">HACER <br> PEDIDO</button>
							</a>	
