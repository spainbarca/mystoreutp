					...
					<?php
				     ...
				     if(!$reservas){
					     ...
					     echo '<p class="help-block small">
							...
							<a href="https://api.whatsapp.com/send?phone=573001112233&text=Hola Hotel Portobelo, necesito hacer un cambio en una reserva" target="_blank">+57 300 111 22 33</a>
