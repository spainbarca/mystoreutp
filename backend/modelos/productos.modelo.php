...
class ModeloProductos{
	...
	static public function mdlIngresarProducto($tabla, $datos){
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_categoria, id_subcategoria, codigo, descripcion, incluye, imagen, stock, precio_compra, precio_venta) VALUES (:id_categoria, :id_subcategoria,:codigo, :descripcion, :incluye, :imagen, :stock, :precio_compra, :precio_venta)");
